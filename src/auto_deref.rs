...
pub(crate) struct AutoDerefInfo {
    ident: syn::Ident,
...
pub(crate) struct AutoDerefFieldsInfo {
    ident: Option<syn::Ident>,
    ty: syn::Type,
}

pub(crate) fn impl_auto_deref_macro(ast: &syn::DeriveInput) -> TokenStream {
    let AutoDerefInfo {
        ident,
        generics,
        ...
        mutable,
        field,
    } = AutoDerefInfo::from_derive_input(ast).unwrap()
    else {
